...
MBM.maps.anatListFile = fullfile('/home/trangc/kg98/trangc/VBM/data/HCP/derivatives/freesurfer/qdec/4_HCP_thick_smooth10_lh_sex_age/y.mgh'); % text file comprise the list of paths to the anatomical maps
...
MBM.stat.continousCov = 3; % covariate in the 3rd column is continuous
MBM.stat.designFile = fullfile('/home/trangc/kg98/trangc/VBM/data/HCP', 'ANCOVA_matrix_HCP_4.txt'); % path to design matrix
...
MBM.eig.eigFile = fullfile('/home/trangc/kg98/trangc/VBM/data/MBM', 'fsaverage_164k_midthickness-lh_emode_200.txt'); % path to eigenmode file
MBM.eig.nEigenmode = 150; % number of eigenmodes for analysis
MBM.eig.saveResult = false; % save the results, i.e., MBM structure
MBM.eig.resultFile = fullfile('results','demoHCP.mat'); % folder where to save the results
