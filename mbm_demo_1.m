...
% ground truths. The list of the filenames of the maps stored in 'thickness'
...
% 'G_two_sample.txt'. 
% 
% All input files are stored in 'data/demo_1' folder.
%
...
%
% This code can also be use to demontrate one way anova test by changing MBM.stat.test 
