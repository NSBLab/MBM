...
% folder is in 'map_filename.txt'. This code includes the part that generates 'map_full_path.txt'
% containing the paths to these maps by adding the directory of these files in your local computer 
% to the filenames.
% 
...
MBM.stat.designFile = fullfile(dataDir, 'G_two_sample.csv'); % path to design matrix
