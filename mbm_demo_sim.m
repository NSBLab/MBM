...
% folder is in 'map_filename.txt'. 'mbm_demo_prerequisite.m' needs to be run before running this demo 
% in order to generate 'map_full_path.txt' containing the paths to these maps 
...
% 'evec_501_masked_S1200.L.midthickness_MSMAll.32k_fs_LR.txt'.
% 
